...
do
  ...
  # python /fabi_project/p3_tract_ttl/TrackToLearn/runners/test.py \
  #   /fabi_project/data/prelim_results/03-test \
  #   try_to_get_learning \
  #   wm-mask \
  #   /fabi_project/data/scratch/rot_test/fibercup2.hdf5 \
  #   fibercup2 \
  #   /fabi_project/data/scratch/rot_test/wm-90deg.nii.gz \
  #   SAC \
  #   /fabi_project/data/prelim_results/00/hyperparameters.json \
